...
//	private Class<? extends TypeHandler> defaultEnumTypeHandler = EnumTypeHandler.class;
	...
	public TypeHandlerRegistry() {
		log.debug("初始化TypeHandlerRegistry");
...
//		log.debug("注册 类型处理器2 javaType={},typeHandler={}",javaType,typeHandler);
//		MappedJdbcTypes mappedJdbcTypes = typeHandler.getClass().getAnnotation(MappedJdbcTypes.class);
//		if (mappedJdbcTypes != null) {
//			log.debug("类上没有标签 javaType={},typeHandler={},mappedJdbcTypes={}",javaType,typeHandler,mappedJdbcTypes);
...
//			}
//		} else {
//			log.debug("类上没有标签 javaType={},typeHandler={}",javaType,typeHandler);
//			register(javaType, null, typeHandler);
//		}
//	}
