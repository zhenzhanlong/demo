 ...
 * 
 */
public class WebServiceImplFileCreating extends ImplCreatingFile {
	...
	public WebServiceImplFileCreating(Configuration configuration) {
		super(configuration);
	}

	public WebServiceImplFileCreating(CreateIApiFileConfig apiFileConfig) {
	...
	public void createFile() {
		// 生成文件
		super.createFile(this.apiFileConfig.getWebServiceImplPackage(), this.apiFileConfig.getWebServiceImplFileName(),
				content.toString());
	}
	...
	public void analysisImplFile() {
		...
		try (Reader reader = Resources
				.getResourceAsReader("imitate/mybatis/code/generation/mapping/xml/WebServiceImpl.xml")) {
