 ...
 * 
 */
public class ServiceImplFileCreating extends ImplCreatingFile {
	...
	public ServiceImplFileCreating(Configuration configuration) {
		super(configuration);
	}

	public ServiceImplFileCreating(CreateIApiFileConfig apiFileConfig) {
	...
	public void createFile() {
		// 生成文件
		super.createFile(this.apiFileConfig.getServiceImplPackage(), this.apiFileConfig.getServiceImplFileName(),
				content.toString());
	}
	...
	public void analysisImplFile() {
		...
		try (Reader reader = Resources
				.getResourceAsReader("imitate/mybatis/code/generation/mapping/xml/ServiceImpl.xml")) {
