 ...
 *
 */
public abstract class IApiCreatingFile extends BaseCreatingFile {
	/**
	 * 日志
	 */
	...
	public IApiCreatingFile(Configuration configuration) {
		super(configuration);
	}
	...
	public void createApiFileProcess() {
		// 第一步解析。要生成的文件的xml的配置
		analysisApiFile();
		// 第二步 循环生成内容、文件
	...
	// 解析xml配置
	public abstract void analysisApiFile();
