...
public enum JdbcType {
	...
	private static Map<String, JdbcType> javaNameLookup = new HashMap<>();
	...
	JdbcType(int code, String javaName) {
		this.TYPE_CODE = code;
	...
	public static JdbcType forJavaName(String jdbcTypeName) {
		JdbcType returnType = javaNameLookup.get(jdbcTypeName.toUpperCase());
		//找不到就默认返回字符串的
		if(null==returnType) {
			returnType= JdbcType.forJavaName("varchar");
		}
		return returnType;
	}
	public static void main(String[] args) {
		System.out.println(JdbcType.forJavaName("varchar").toString());
		System.out.println(JdbcType.forJavaName("varchar").TYPE_NAME);
		System.out.println(JdbcType.forJavaName("int").toString());
		System.out.println(JdbcType.forJavaName("int").TYPE_NAME);
	}
}
